...
/* WIDGETS */
	...
	Class WQ_Widget_Search extends WP_Widget_Search {
		function widget( $args, $instance ) {
			...
			?>
				<div class="at-blog-search">
					<form method="get" action="<?php echo home_url(); ?>">
						<input type="text" name="s" placeholder="<?php echo $title; ?>">
						<button type="submit">
	...
	Class WQ_Widget_Recent_Posts extends WP_Widget_Recent_Posts {
		...
		<div class="at-blog-recent-post">

			<?php echo $args['before_widget']; ?>

			<?php if ( $title ) { ?>
				<div class="at-blog-recent-post__header">
					<h2><?php echo $title; ?></h2>
				</div>
			<?php } ?>

			<div class="at-blog-recent-post__box">
				<?php
					$itens = 0;
				...
				?>
					<a href="<?php the_permalink(); ?>">
						<figure>
							<?php getImageThumb( $attachID, 'full'); ?>
						</figure>
						<div class="at-blog-recent-post__content">
							<h3><?php get_the_title() ? the_title() : the_ID(); ?></h3>
							<span><?php echo get_the_date('F', get_the_ID()); ?> <?php echo get_the_date('d', get_the_ID()); ?>, <?php echo get_the_date('Y', get_the_ID()); ?></span>
						</div>
					</a>
				<?php endwhile; ?>
			</div>
	...
	Class WQ_Widget_Tag_Cloud extends WP_Widget_Tag_Cloud {
	    function widget( $args, $instance ) {
			...
			$title = apply_filters( 'widget_title', $title, $instance, $this->id_base );
		?>
			<div class="at-blog-tag">

				<div class="at-blog-tag__header">
					<h2><?php echo $title; ?></h2>
				</div>
				<div class="at-blog-tag__list">
					<ul>
						<?php
	...
	Class WQ_Categories_Widget extends WP_Widget_Categories {
		function widget( $args, $instance ) {
			...
			?>
				...
				<div class="at-blog-cetegory">
					<?php
						if ( $title ) {
							?>
								<div class="at-blog-cetegory__header">
									<h2><?php echo $title; ?></h2>
								</div>
							<?php
						}
