...
?>
	...
	<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
		<div <?php wc_product_class( 'at-shop__product__card', $product ); ?>>
			<a href="<?php echo get_the_permalink($product->get_id()); ?>">
				<figure>
					<?php echo getImageThumb(get_post_thumbnail_id($product->get_id()), 'woocommerce_thumbnail'); ?>
				</figure>

				<div class="at-shop__product__card__content">
					...
					<div class="at-shop__product__card__price">
						...
						<p>Stet mnesarchum has cu, dicam altera timeam an mel.</p>
					</div>
